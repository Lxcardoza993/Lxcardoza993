<div align="center">
  <img src="assets/banner.svg" alt="Lx 🎀 — 魔法学徒的代码小屋" width="100%">
</div>
...
```yaml
name: Lx 🎀
role: front-end magician in training ✨
loves: [milk tea 🧋, pixel-perfect UIs 🎨, cute animations]
learning: Vue3 · React · Python · UI/UX
superpower: turning coffee into components ☕→⚛️
```
